              ...
              <div className="text-center">
                <div className="relative inline-block mb-3 sm:mb-4">
                  ...
                  <div className="relative w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-white to-gray-100 rounded-xl border border-violet-200 flex items-center justify-center mx-auto shadow-xl">
                    <svg className="w-6 h-6 sm:w-7 sm:h-7 text-violet-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0z" />
                    </svg>
                  </div>
                </div>
                <h1 className="text-xl sm:text-2xl font-bold text-gray-900 mb-1">Join Campus</h1>
                <p className="text-gray-600 text-sm sm:text-base">Create your student account</p>
              </div>
            </div>
            ...
            <div className="max-h-[calc(100vh-280px)] sm:max-h-[calc(100vh-320px)] overflow-y-auto p-4 sm:p-6 space-y-4 sm:space-y-5">
              <form onSubmit={handleSignup} className="space-y-4 sm:space-y-5">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs text-gray-500">OTP will be sent here</p>
                </div>
              ...
              <div className="relative my-5 sm:my-6">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-4 bg-white/90 text-gray-500 font-medium">Already have account?</span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-3 gap-2 sm:gap-3 pt-3 sm:pt-4">
                {[
                  ...
                  <div key={i} className="text-center p-2 sm:p-3 bg-white/60 border border-violet-200/40 rounded-lg">
