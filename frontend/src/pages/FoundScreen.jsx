...
import { Search, Filter, HelpCircle, Package, Eye, User, Upload, ShoppingBag, MapPin } from "lucide-react"
      ...
      <div className="flex min-h-screen relative z-10">
        ...
        <div className="w-80 bg-gray-800/50 backdrop-blur-md border-r border-gray-700/50 p-6">
          <div className="mb-8">
            ...
            <p className="text-gray-400 text-sm">Lost & Found Dashboard</p>
          </div>
          ...
          <div className="mt-8 p-4 bg-gradient-to-br from-violet-600/20 to-blue-600/20 rounded-xl border border-violet-600/30">
            <h3 className="text-violet-300 font-semibold mb-2">Lost & Found Stats</h3>
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                <span className="text-gray-400">Items Found:</span>
                <span className="text-violet-300 font-medium">{items.length}</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-gray-400">Active Searches:</span>
        ...
        <div className="flex-1 p-8 overflow-y-auto max-h-screen">
          ...
          <div className="mb-8 bg-gray-800/50 backdrop-blur-md border border-gray-700/50 p-6 rounded-2xl shadow-xl">
            <div className="flex justify-between items-center">
              <div>
                <h1 className="text-3xl font-bold text-white mb-2">Lost & Found Center</h1>
                <p className="text-gray-400">Help reunite students with their belongings</p>
              </div>
              <button
          ...
          <div className="bg-gray-800/50 backdrop-blur-md border border-gray-700/50 p-8 rounded-2xl shadow-xl">
            <div className="flex items-center mb-6">
              <MapPin className="w-6 h-6 text-violet-400 mr-3" />
              <h2 className="text-2xl font-bold text-white">Found Items</h2>
              {!loading && <span className="ml-auto text-gray-400 text-sm">{items.length} items found</span>}
            </div>

            {loading && (
              <div className="flex items-center justify-center py-12">
                <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-violet-500"></div>
                <p className="text-gray-400 ml-4">Loading items...</p>
              </div>
            )}
                    ...
                    <div className="p-6">
                      ...
                      {item.finder && (
                        <div className="mb-4 p-3 bg-gray-800/50 rounded-lg border border-gray-700/50">
                          ...
                          <p className="text-gray-400 text-xs">{item.finder.email}</p>
                        </div>
                      )}
