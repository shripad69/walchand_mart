      ...
      >
        <div className="p-6 h-full overflow-y-auto">
          ...
          <div className="mt-6 p-3 bg-white/60 backdrop-blur-sm border border-violet-200/40 rounded-lg text-center">
            ...
            <div className="text-xs font-semibold text-gray-700">Help Others Find</div>
...
export default function UploadFoundScreen() {
  ...
  const generateAIDescription = async () => {
    ...
    setAiLoading(true)
    try {
      const res = await axios.post(`${config.BASE_URL}${config.GEN_FOUND_DESC}`, {
          ...
          <div className="mb-6 sm:mb-8 bg-white/90 backdrop-blur-lg border border-violet-200/50 p-4 sm:p-6 rounded-2xl shadow-xl">
            <div className="flex justify-between items-center">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Report Found Item</h1>
                  <p className="text-gray-600 text-sm">Help reunite students with their belongings</p>
                </div>
              </div>
              <button
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="mt-6 p-4 bg-white/80 backdrop-blur-sm border border-violet-200/50 rounded-xl shadow-lg">
              <div className="text-center">
                <div className="text-2xl mb-2">🤝</div>
                <h3 className="font-semibold text-gray-700 mb-1">Help Build Our Campus Community</h3>
                <p className="text-sm text-gray-600">Every found item helps a fellow student. Thank you for being part of our safe campus marketplace!</p>
              </div>
            </div>
          </div>
        </div>
