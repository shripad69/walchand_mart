        ...
        <div className="w-full max-w-md">
            ...
            <div className="text-center mb-6 sm:mb-8">
              <div className="relative inline-block mb-4 sm:mb-6">
                ...
                <div className="relative w-16 h-16 sm:w-18 sm:h-18 bg-gradient-to-br from-white to-gray-100 rounded-xl border border-violet-200 flex items-center justify-center mx-auto shadow-xl">
                  <svg className="w-8 h-8 sm:w-9 sm:h-9 text-violet-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <p className="text-gray-600 text-base sm:text-lg">Sign in to your campus marketplace</p>
              <p className="text-violet-600 text-sm mt-1 font-semibold">Walchand College Students Only</p>
            </div>

            <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-2">College Email Address</label>
                <input
                  type="email"
                  value={email}
            ...
            <div className="my-6 sm:my-8">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-4 bg-white/90 text-gray-500 font-medium">New to campus?</span>
                </div>
              </div>
            </div>
          ...
          <div className="mt-4 sm:mt-6 text-center">
            <div className="inline-flex items-center px-4 py-2 bg-white/60 backdrop-blur-sm border border-violet-200/40 rounded-lg">
              ...
              <span className="text-xs sm:text-sm text-gray-600">Secure login for verified students only</span>
            </div>
          </div>
        </div>
      </main>
