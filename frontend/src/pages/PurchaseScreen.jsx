...
import { Search, Filter, ShoppingBag, Package, Eye, User, Upload, HelpCircle, Menu, X, ChevronLeft, ChevronRight } from "lucide-react"

const categories = ["Books", "Electronics", "Stationery", "Clothing", "Others"]

// Sidebar Component
function Sidebar({ sidebarOpen, setSidebarOpen, navigate, productsCount }) {
  return (
    <>
      ...
      >
        <div className="p-6 h-full overflow-y-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 text-sm">Campus Marketplace</p>
          </div>
          ...
          <div className="p-4 bg-gradient-to-br from-violet-100/80 to-blue-100/80 backdrop-blur-sm rounded-xl border border-violet-200/50 shadow-lg">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                ...
                <span className="text-violet-600 font-semibold bg-violet-50 px-2 py-1 rounded-full text-sm">{productsCount}</span>
              </div>
              <div className="flex justify-between items-center">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-blue-600 font-semibold bg-blue-50 px-2 py-1 rounded-full text-sm">🛡️ Verified</span>
              </div>
            </div>
          </div>
          ...
          <div className="mt-6 p-3 bg-white/60 backdrop-blur-sm border border-violet-200/40 rounded-lg text-center">
            ...
            <div className="text-xs font-semibold text-gray-700">Campus Safe Trading</div>
            <div className="text-xs text-gray-600">Students helping students</div>
          </div>
        </div>
      </div>
    </>
          ...
          <div className="mb-8 bg-white/90 backdrop-blur-lg border border-violet-200/50 p-6 rounded-2xl shadow-xl">
            <div className="flex justify-between items-center">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">Campus Marketplace</h1>
                  <p className="text-gray-600 text-sm sm:text-base">Discover amazing deals from fellow students</p>
                </div>
              </div>
              <button
          ...
          <div className="bg-white/90 backdrop-blur-lg border border-violet-200/50 p-6 sm:p-8 rounded-2xl shadow-xl">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center">
                <Package className="w-6 h-6 text-violet-500 mr-3" />
                <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Available Products</h2>
              </div>
              {!loading && (
                <div className="text-right">
                  <span className="text-gray-500 text-sm">{allProducts.length} products found</span>
                  {totalPages > 1 && (
